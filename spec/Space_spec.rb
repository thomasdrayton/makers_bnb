describe Space do
  ...
  let!(:space) do
    Space.create(id: 1, name: 'Flat', city: 'London', street: 'Comercial Street', postcode: 'E1 6LT', price: 72.06, description: "It's a flat mate", startDate:Date.new(2001,1,2), endDate: Date.new(2001,1,2), user_id: user.id)
  end
